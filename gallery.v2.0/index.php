...
if(isset($_GET['i'])){
//    header("location:http://ericsn.me/gallery/fix-up.php");
}

//Ultima edição DIA 24/01/2018: Adicionando mais uma opção para reduzir a string GET. Linha 524 ou pesquise por "24/01/2018" neste arquivo.

if(isset($_GET["i"]) && $_GET["i"]!==""){/* v2.0 - Updated Oct 24, 2018 - 24:54 */
...
//SELETORES EM CACHE: inicio --------------------------------------------
        ...
        var live_cams = $(".live_cams");
                <?php
                    ...
                    foreach ($arr_videos as $gallery_e_video){
                        ...
                        if($arr_gallery_e_video[0] === $_GET['i']){
                            ...
                            if($detect->isMobile()){
                                $link_video="<span id='video' style='cursor: pointer; margin-left: 30px; color: tomato'>VIDEO HERE</span>";
                            }else{
                                $link_video="<span id='video' class='tooltipped' data-position='top' data-delay='50' data-tooltip='".$arr_gallery_e_video[1]."' style='cursor: pointer; margin-left: 30px; color: tomato'>VIDEO HERE</span>";
                            }
                            break;
                        }else{
                            $link_video="";
            ...
            live_cams.on("click", function() {
                window.location.href='https://chaturbate.com/in/?track=default&tour=grq0&campaign=55K2d';
            });
                                                ...
                                                swal({
                                                    ...
                                                    preConfirm: function(text) {
                                                        ...
                                                        if(text.length >= 200 && text!==""){
                                                                ...
                                                                var new_text1 = replaceAll(text, cut, chave+"."); // RESULTADO: _.
                                                                ////cortando e substituindo a extensao da imagem por pelo caractere chave escolhido | RESULTADO: "._"
                                                                var new_text2 = replaceAll(new_text1, "jpg", chave); // RESULTADO ._
                                                                //criando o caractere chave
                                                                var head_text = chave+"="+cut+";";
                                                                //Soma o numero de caracteres do cabeçalho e do resto do texto 
                                                                var length = head_text.length+new_text2.length;
                                                                //verificando se é preciso uma segunda camada de otimização
                                                                if(length >= 8000){ //CRIADO DIA 24/01/2018
                                                                    // Substituindo .__. por |
                                                                    var new_text3 = replaceAll(new_text2, "."+chave+chave+".", "|");//"."+chave+chave+"." RESULTADO .__.
                                                                    length = head_text.length+new_text3.length;
                                                                    swal({
                                                                        title: "New URLs",
                                                                        input: 'textarea',
                                                                        inputValue: "Length: "+length+" "+head_text+new_text3,
...
<section class="cntr">
    <div class="m10">
        ...
        <center>
            ...
            <?php }?>
            <!--span class="live_cams tooltipped" style='cursor: pointer; margin-left: 30px; color: mediumseagreen' data-position="top" data-delay="50" data-tooltip="https://chaturbate.com"><b>Live Cams</b></span-->
        </center>        
